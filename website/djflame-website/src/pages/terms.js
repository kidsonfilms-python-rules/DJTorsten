...
class TermsPage extends React.Component {
  ...
  <div className="termsMain">
    <h1 id="terms">
      <strong>DJFlame Terms of Service</strong>
    </h1>
    <h3 className="lastUpdated">Last Modified April 6, 2021</h3>
    <h2>Introduction and Agreement to Terms</h2>
    <p>
      Welcome to DJFlame! These Terms of Service constitute a legally binding
      agreement made between you, whether personally or on behalf of an entity
      (“you”) and DJFlame LLC (“we,” “us” or “our”), concerning your access to
      and use of the DJFlame website, DJFlame App, DJFlame Mobile App, as well
    ...
    <p>
      You agree that by accessing the Product, you have read, understood, and
      ...
      using the Product and you must discontinue use immediately.
    </p>
    <p>
      Supplemental Terms of Service or documents that may be posted on the
      Product from time to time are hereby expressly incorporated herein by
    ...
    <p>
      ...
      these Terms of Service, and you waive any right to receive specific notice
      of each such change.
    </p>
    <p>
      It is your responsibility to periodically review these Terms of Service to
      ...
      Terms of Service by your continued use of the Product after the date such
      revised Terms of Service are posted.
    </p>
    <p>
      The information provided on the Product is not intended for distribution
    ...
    <p>
      Accordingly, those persons who choose to access the Product from other
    ...
    <p>
      ...
      directly supervised by, their parent or guardian to use the Product. If
      you are a minor, you must have your parent or guardian read and agree to
      these Terms of Service prior to you using the Product.
    </p>
    <h2>INTELLECTUAL PROPERTY RIGHTS</h2>
    <p>
      Unless otherwise indicated, the Product is our proprietary property and
      all source code, databases, functionality, software, website designs,
      software designs, audio (if installed or updated onto your computer by
      us), video, text, photographs, and graphics on the Product (collectively,
    ...
    <p>
      The Content and the Marks are provided on the Product “AS IS” for your
      information and personal use only. Except as expressly provided in these
      Terms of Service, no part of the Product and no Content or Marks may be
    ...
    <p>
      Provided that you are eligible to use the Product, you are granted a
      limited license to access and use the Product for personal and
      non-commercial use. We reserve all rights not expressly granted to you in
      and to the Product, the Content and the Marks.
    </p>
    <h2>User Representation</h2>
    <p>By using the Product, you represent and warrant that:</p>
    <ol>
      <li>
      ...
      <li>
        you have the legal capacity and you agree to comply with these Terms of
        Service;
      </li>
      <li>you are not under the age of 13;</li>
      <li>
        not a minor in the jurisdiction in which you reside, or if a minor, you
        have received parental permission to use the Product
      </li>
      <li>
        you will not access the Product through automated or non-human means,
      ...
      <li>
        your use of the Product will not violate any applicable law or
        regulation.
      </li>
    </ol>
    <p>
      ...
      refuse any and all current or future use of the Product (or any portion
      thereof).
    </p>
    <h2>User Registration</h2>
    <p>
      You may be required to register with the Product. You agree to keep your
    ...
    <p>
      You may not access or use the Product for any purpose other than that for
      which we make the Product available. The Product may not be used in
      connection with any commercial endeavors except those that are
      specifically endorsed or approved by us.
    </p>
    <p>As a user of the Product, you agree not to:</p>
    <ol>
      <li>
        systematically retrieve data or other content from the Product to create
        or compile, directly or indirectly, a collection, compilation, database,
        or directory without written permission from us.
      </li>
      <li>
        make any unauthorized use of the Product, including collecting usernames
      ...
      <li>
        use a buying agent or purchasing agent to make purchases on the Product.
      </li>
      <li>use the Product to advertise or offer to sell goods and services.</li>
      <li>
      ...
      <li>
        ...
        comments, messages, or any other form of content generation, or using
        any data mining, robots, or similar data gathering and extraction tools.
      </li>
      <li>
        interfere with, disrupt, or create an undue burden on the Product or the
      ...
      <li>
        use any information obtained from the Product in order to harass, abuse,
        or harm another person.
      </li>
      <li>
        use the Product as part of any effort to compete with us or otherwise
        use the Product and/or the Content for any revenue-generating endeavor
        or commercial enterprise.
      </li>
      <li>
        decipher, decompile, disassemble, or reverse engineer any of the
        software comprising or in any way making up a part of the Product.
      </li>
      <li>
      ...
      <li>
        ...
        engaged in providing any portion of the Product to you.
      </li>
      <li>
      ...
      <li>
        copy or adapt the Product’s software, including but not limited to
      ...
      <li>
        ...
        with any party’s uninterrupted use and enjoyment of the Product or
        modifies, impairs, disrupts, alters, or interferes with the use,
        features, functions, operation, or maintenance of the Product.
      </li>
      <li>
      ...
      <li>
        ...
        or offline reader that accesses the Product, or using or launching any
      ...
      <li>
        break any copyright laws in your country or jurisdiction by using our
        software to download any copyrighted material.
      </li>
    </ol>
    <h2>User Generated Contributions</h2>
    <p>
      The Product may invite you to chat, contribute to, or participate in
      blogs, DJFlame online-parties ("Parties"), online forums, and other
      ...
      content and materials to us or on the Product, including but not limited
    ...
    <p>
      Contributions may be viewable by other users of the Product. As such, any
    ...
    <ol>
      ...
      <li>
        ...
        Product, and other users of the Product to use your Contributions in any
        manner contemplated by the Product and these Terms of Use.
      </li>
      <li>
        ...
        contemplated by the Product and these Terms of Use.
      </li>
    ...
    <p>
      Any use of the Product in violation of the foregoing violates these Terms
      of Use and may result in, among other things, termination or suspension of
      your rights to use the Product.
    </p>
    <h2>Contribution License</h2>
    <p>
      By posting your Contributions to any part of the Product [or making
      Contributions accessible to the Product by linking your account from the
      Product to any of your social networking accounts], you automatically
    ...
    <p>
      ...
      provided by you in any area on the Product.
    </p>
    <p>
      You are solely responsible for your Contributions to the Product and you
    ...
    <p>
      ...
      Contributions to place them in more appropriate locations on the Product;
    ...
    <p>
      If you access the Product via a mobile application, then we grant you a
    ...
    <ol>
      ...
      <li>
        use the application to send automated queries to any webProduct or to
    ...
    <ol>
      ...
      <li>
        ...
        the U.S. government as a “terrorist supporting” country and (ii) you are
      ...
      <li>
        ...
        contained in these Terms of Service, and that each App Distributor will
        have the right (and will be deemed to have accepted the right) to
        enforce the Terms of Service in this mobile application license
        contained in these Terms of Service against you as a third-party
        beneficiary thereof.
      </li>
    </ol>
    <h2>Social Media</h2>
    <p>
      As part of the functionality of the Product, you may link your account
      ...
      Third-Party Account login information through the Product; or (2) allowing
      us to access your Third-Party Account, as is permitted under the
      applicable Terms of Service that govern your use of each Third-Party
      Account.
    </p>
    <p>
      ...
      Third-Party Account, without breach by you of any of the Terms of Service
    ...
    <p>
      ...
      Network Content”) so that it is available on and through the Product via
    ...
    <p>
      ...
      Accounts may be available on and through your account on the Product.
      ...
      available on and through the Product. You will have the ability to disable
      the connection between your account on the Product and your Third-Party
    ...
    <p>
      You can deactivate the connection between the Product and your Third-Party
    ...
    <p>
      ...
      ideas, feedback, or other information regarding the Product
    ...
    <p>
      The Product may contain (or you may be sent via the Product) links to
    ...
    <p>
      ...
      through the Product or any Third-Party Content posted on, available
      through, or installed from the Product, including the content, accuracy,
    ...
    <p>
      ...
      endorsement thereof by us. If you decide to leave the Product and access
    ...
    <p>
      ...
      Product or relating to any applications you use or install from the
      Product. Any purchases you make through Third-Party Websites will be
    ...
    <ol>
      <li>monitor the Product for violations of these Terms of Service;</li>
      <li>
      ...
      <li>
        ...
        liability, to remove from the Product or otherwise disable all files and
        content that are excessive in size or are in any way burdensome to our
        systems;
      </li>
      <li>
        otherwise manage the Product in a manner designed to protect our rights
        and property and to facilitate the proper functioning of the Product.
      </li>
    </ol>
    <h2>Privacy Policy</h2>
    <p>
      We care about data privacy and security. Please review our{" "}
      <a href="privacy.html">Privacy Policy</a> posted on the Product. By using
      the Product, you agree to be bound by our Privacy Policy, which is
      incorporated into these Terms of Service. Please be advised part of the
      Product is hosted in the United States.
    </p>
    <p>
      If you access the Product from the European Union, Asia, or any other
      ...
      the United States, then through your continued use of the Product, you are
    ...
    <p>
      ...
      we will delete that information from the Product as quickly as is
      reasonably practical.
    </p>
    <h2>Digital Miillennium Copyright Act (DMCA) Notice and Policy</h2>
    <p>
      <b>Notifications</b>
    </p>
    <p>
      We respect the intellectual property rights of others. If you believe that
      any material available on or through the Product infringes upon any
    ...
    <p>
      ...
      that material located on or linked to by the Product infringes your
    ...
    <ol>
      ...
      <li>
        ...
        or, if multiple copyrighted works on the Product are covered by the
        Notification, a representative list of such works on the Product;
      </li>
      <li>
    ...
    <p>
      ...
      Product as a result of a mistake or misidentification, you may submit a
    ...
    <ol>
      ...
      <li>
        ...
        Court in which your address is located, or if your address is outside
        the United States, for any judicial district in which we are located;
      </li>
      <li>
        a statement that you will accept service of process from the party that
    ...
    <p>djflamedev@gmail.com</p>
    <br />
    <h2>Copyright Infringments</h2>
    <p>
      We respect the intellectual property rights of others. If you believe that
      any material available on or through the Product infringes upon any
    ...
    <p>
      ...
      if you are not sure that material located on or linked to by the Product
      infringes your copyright, you should consider first contacting an
      attorney.
    </p>
    <h2>Term and Termination</h2>
    <p>
      These Terms of Service shall remain in full force and effect while you use
      the Product. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF
      SERVICE, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT
      NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE PRODUCT (INCLUDING
      ...
      IN THE Product OR DELETE [YOUR ACCOUNT AND] ANY CONTENT OR INFORMATION
    ...
    <h2>Modifications and Interuptions</h2>
    <p>
      We reserve the right to change, modify, or remove the contents of the
      Product at any time or for any reason at our sole discretion without
      notice. However, we have no obligation to update any information on our
      Product. We also reserve the right to modify or discontinue all or part of
      the Product without notice at any time.
    </p>
    <p>
      We will not be liable to you or any third party for any modification,
      price change, suspension, or discontinuance of the Product.
    </p>
    <p>
      We cannot guarantee the Product will be available at all times. We may
      experience hardware, software, or other problems or need to perform
      maintenance related to the Product, resulting in interruptions, delays, or
      errors.
    </p>
    <p>
      We reserve the right to change, revise, update, suspend, discontinue, or
      otherwise modify the Product at any time or for any reason without notice
      ...
      Product during any downtime or discontinuance of the Product.
    </p>
    <p>
      Nothing in these Terms of Service will be construed to obligate us to
      maintain and support the Product or to supply any corrections, updates, or
      releases in connection therewith.
    </p>
    <h2>Governing Law</h2>
    <p>
      These Terms of Service and your use of the Product are governed by and
      construed in accordance with the laws of the State of California
      applicable to agreements made and to be entirely performed within the
      State/Commonwealth of California, without regard to its conflict of law
      principles.
    </p>
    ...
    <p>
      ...
      <a href="https://www.adr.org">www.adr.org</a>. Your arbitration fees and
      ...
      will take place in United States, California. Except as otherwise provided
    ...
    <p>
      ...
      to the Product be commenced more than one (1) years after the cause of
    ...
    <h2>Corrections</h2>
    <p>
      There may be information on the Product that contains typographical
      errors, inaccuracies, or omissions that may relate to the Product,
      ...
      omissions and to change or update the information on the Product at any
      time, without prior notice.
    </p>
    <h2>Disclaimer</h2>
    <p>
      THE PRODUCT IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT
      YOUR USE OF THE PRODUCT AND OUR SERVICES WILL BE AT YOUR SOLE RISK. TO THE
      FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR
      IMPLIED, IN CONNECTION WITH THE PRODUCT AND YOUR USE THEREOF, INCLUDING,
      ...
      REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE PRODUCT’S
      CONTENT OR THE CONTENT OF ANY WEBSITES LINKED TO THE PRODUCT AND WE WILL
      ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR
      INACCURACIES OF CONTENT AND MATERIALS, (2) PERSONAL INJURY OR PROPERTY
      DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF
      THE PRODUCT, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS
      AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION
      STORED THEREIN, (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR
      FROM THE PRODUCT, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH
      MAY BE TRANSMITTED TO OR THROUGH THE PRODUCT BY ANY THIRD PARTY, AND/OR
      ...
      POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE PRODUCT. WE DO
      NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT
      OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE PRODUCT, ANY
    ...
    <p>
      ...
      PRODUCT, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
      NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY
      TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION,
      WILL AT ALL TIMES BE LIMITED TO $500.00 USD. CERTAIN US STATE LAWS AND
    ...
    <p>
      ...
      use of the Product; (3) breach of these Terms of Use; (4) any breach of
      ...
      other user of the Product with whom you connected via the Product.
    ...
    <h2>User Data</h2>
    <p>
      We will maintain certain data that you transmit to the Product for the
      purpose of managing the performance of the Product, as well as data
      relating to your use of the Product. Although we perform regular routine
      backups of data, you are solely responsible for all data that you transmit
      or that relates to any activity you have undertaken using the Product. You
    ...
    <p>
      Visiting the Product, sending us emails, and completing online forms
      constitute electronic communications. You consent to receive electronic
      communications, and you agree that all agreements, notices, disclosures,
      and other communications we provide to you electronically, via email and
      on the Product, satisfy any legal requirement that such communication be
      in writing. YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES,
      CONTRACTS, ORDERS, AND OTHER RECORDS, AND TO ELECTRONIC DELIVERY OF
      NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY
      US OR VIA THE PRODUCT. You hereby waive any rights or requirements under
    ...
    <p>
      ...
      Product or in respect to the Product constitute the entire agreement and
      ...
      Product. You agree that these Terms of Use will not be construed against
    ...
    <h2>Contact Us</h2>
    <p>
      In order to resolve a complaint regarding the Product or to receive
      further information regarding use of the Product, please contact us at:{" "}
      <a href="mailto:djflamedev@gmail.com">djflamedev@gmail.com</a>
    </p>
  </div>
  <Footer />
</>
